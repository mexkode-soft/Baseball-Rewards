...
-- Archivo consolidado generado a partir de las migraciones modulares 000–362.
--
-- USO RECOMENDADO:
...
--   - La migración 361 se omite porque la 362 contiene la reparación final
--     de permisos y UPSERT para user_consents.
-- =============================================================================
